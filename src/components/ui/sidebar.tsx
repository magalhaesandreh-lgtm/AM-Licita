    ...
    if (!hasMounted) {
      return (
        <aside
          ref={ref}
          className={cn(
            "hidden md:flex flex-col shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border transition-[width] duration-200 ease-linear",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-1 overflow-auto px-3",
        className
      )}
      {...props}
    />
